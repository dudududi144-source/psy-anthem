...
const LIB = {
  ...
  pad: [
    R({ unison: 5, detune: 0.0090, filtBase: 1250, filtEnv: 1900, filtAtk: 0.60, filtDec: 1.20, filtSus: 0.75, Q: 1.0, atk: 0.60, dec: 0.40, sus: 0.88, rel: 1.80, amp: 0.082, spread: 1.00, pump: 0.30 }), // 0 lush-wide (lusher)

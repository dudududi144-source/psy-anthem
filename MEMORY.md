...
25. The web/ render-core has a real DC-offset bug (−0.085/−0.087 both channels — measured on v12.3 AND v13.9.1, every version so far) and masters quiet (−12.6 → −15.5 LUFS after the v13.x "simplify" iterations). It is the preview path, not the family sound. Do not confuse its output with foundation's mastered chain.
